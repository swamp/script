...
> 0003: ld32 $0060 0000001E     ; 30
> 0004: sgt32 $0000 $0060       ; a > 30
> 0005: bnz @8                  ; &&
> 0006: ld32 $0068 00000016     ; 22 
> 0007: slt32 $0004 $0068       ; b < 22
> 0008: bnz @B                  ; skip if not equal
    > 0009: ld32 $0008 00000001     ; match_expr = 1
    > 000A: jmp @11                 ; jump to end


> 000B: ld32 $0070 00000030     ; 48
> 000C: sgt32 $0004 $0070       ; b > 48
