...
pub use crate::{
    ...
    ResolvedFunction, ResolvedFunctionRef, ResolvedGuard, ResolvedIndexType, ResolvedIntType,
    ...
    ResolvedProgramState, ResolvedRustType, ResolvedRustTypeRef, ResolvedStaticCall,
    ...
    ResolvedTupleType, ResolvedTupleTypeRef, ResolvedType, ResolvedTypeForParameter,
