...
pub use crate::{
    ...
    ResolvedExternalFunctionDefinitionRef, ResolvedIndexType, ResolvedInternalFunctionCall,
    ...
    ResolvedMutVariable, ResolvedParameter, ResolvedPattern, ResolvedProgram, ResolvedStatement,
