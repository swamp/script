...
pub use crate::{
    ...
    ResolvedFunction, ResolvedFunctionRef, ResolvedFunctionSignature, ResolvedIndexType,
    ...
    ResolvedTupleTypeRef, ResolvedType, ResolvedUnaryOperator, ResolvedUnitType,
