...
pub use crate::{
    ...
    ResolvedExternalFunctionDefinitionRef, ResolvedFunctionData, ResolvedImplMember,
    ResolvedIndexType, ResolvedIndexTypeRef, ResolvedInternalFunctionCall,
    ResolvedInternalFunctionDefinition, ResolvedInternalFunctionDefinitionRef, ResolvedIterator,
    ResolvedLiteral, ResolvedMatch, ResolvedMatchArm, ResolvedMemberCall, ResolvedModule,
    ResolvedModuleRef, ResolvedMutArray, ResolvedMutArrayRef, ResolvedMutStructTypeField,
    ResolvedMutStructTypeFieldRef, ResolvedMutVariable, ResolvedParameter, ResolvedPattern,
    ResolvedProgram, ResolvedStatement, ResolvedStringPart, ResolvedStructInstantiation,
    ResolvedStructType, ResolvedStructTypeField, ResolvedStructTypeFieldRef, ResolvedStructTypeRef,
    ResolvedTupleType, ResolvedType, ResolvedUnaryOperator, ResolvedUnitType, ResolvedVariable,
    ResolvedVariableAssignment, ResolvedVariableRef, UnaryOperator,
};
