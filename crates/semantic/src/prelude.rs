...
pub use crate::{
    ...
    FileId, Fp, FunctionTypeSignature, ResolvedAnonymousStructFieldType,
    ...
    ResolvedCompoundOperator, ResolvedCompoundOperatorKind, ResolvedConstant, ResolvedConstantRef,
    ResolvedDefinition, ResolvedEnumLiteralData, ResolvedEnumType, ResolvedEnumTypeRef,
    ResolvedEnumVariantCommon, ResolvedEnumVariantSimpleType, ResolvedEnumVariantStructFieldType,
