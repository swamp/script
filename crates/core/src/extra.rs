...
use std::rc::Rc;
use swamp_script_semantic::{RustTypeRef, Type};
...
pub struct SparseValueMap {
    ...
    pub rust_type_ref_for_id: RustTypeRef,
}
...
impl SparseValueMap {
    #[must_use]
    pub fn new(rust_type_ref_for_id: RustTypeRef, value_item_type: Type) -> Self {
