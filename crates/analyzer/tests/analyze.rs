...
Match(ResolvedMatch { arms: [ResolvedMatchArm { pattern: EnumPattern(ResolvedEnumVariantType { owner: ResolvedEnumType { name: ResolvedLocalTypeIdentifier(<6:9>), assigned_name: "GameState", module_path: ["test"], number: 1 }, data: Nothing, name: ResolvedLocalTypeIdentifier(<22:7>), assigned_name: "Playing", number: 0 }, None), expression: Literal(IntLiteral(1, <126:1>, ResolvedIntType)), expression_type: Int(ResolvedIntType) }, ResolvedMatchArm { pattern: EnumPattern(ResolvedEnumVariantType { owner: ResolvedEnumType { name: ResolvedLocalTypeIdentifier(<6:9>), assigned_name: "GameState", module_path: ["test"], number: 1 }, data: Nothing, name: ResolvedLocalTypeIdentifier(<35:6>), assigned_name: "Paused", number: 0 }, None), expression: Literal(IntLiteral(2, <143:1>, ResolvedIntType)), expression_type: Int(ResolvedIntType) }, ResolvedMatchArm { pattern: EnumPattern(ResolvedEnumVariantType { owner: ResolvedEnumType { name: ResolvedLocalTypeIdentifier(<6:9>), assigned_name: "GameState", module_path: ["test"], number: 1 }, data: Nothing, name: ResolvedLocalTypeIdentifier(<47:8>), assigned_name: "GameOver", number: 0 }, None), expression: Literal(IntLiteral(3, <162:1>, ResolvedIntType)), expression_type: Int(ResolvedIntType) }, ResolvedMatchArm { pattern: PatternList([Wildcard(<169:1>)]), expression: UnaryOp(ResolvedUnaryOperator { left: Literal(IntLiteral(1, <175:1>, ResolvedIntType)), kind: Negate, resolved_type: Int(ResolvedIntType), node: <174:1> }), expression_type: Int(ResolvedIntType) }], expression: VariableAccess(ResolvedVariable { name: <60:10>, resolved_type: Enum(ResolvedEnumType { name: ResolvedLocalTypeIdentifier(<6:9>), assigned_name: "GameState", module_path: ["test"], number: 1 }), mutable_node: None, scope_index: 0, variable_index: 0 }) })
