...
---
StructInstantiation(ResolvedStructInstantiation { source_order_expressions: [(1, Literal(IntLiteral(3, <102:1>, ResolvedIntType))), (0, Literal(IntLiteral(4, <108:1>, ResolvedIntType)))], struct_type_ref: RefCell { value: ResolvedStructType { name: <16:9>, assigned_name: "Something", anon_struct_type: ResolvedAnonymousStructType { defined_fields: SeqMap("a": ResolvedAnonymousStructFieldType { identifier: ResolvedFieldName(<40:1>), field_type: Int(ResolvedIntType), index: 0 }, "b": ResolvedAnonymousStructFieldType { identifier: ResolvedFieldName(<60:1>), field_type: Int(ResolvedIntType), index: 0 }) }, number: 1, functions: SeqMap() } }, display_type_ref: Struct(RefCell { value: ResolvedStructType { name: <16:9>, assigned_name: "Something", anon_struct_type: ResolvedAnonymousStructType { defined_fields: SeqMap("a": ResolvedAnonymousStructFieldType { identifier: ResolvedFieldName(<40:1>), field_type: Int(ResolvedIntType), index: 0 }, "b": ResolvedAnonymousStructFieldType { identifier: ResolvedFieldName(<60:1>), field_type: Int(ResolvedIntType), index: 0 }) }, number: 1, functions: SeqMap() } }), has_rest: false })
